...
const getGenderPhoto = (name) => {
  if (!name) return '/src/assets/user.avatar.png';
  const lowerName = name.toLowerCase();
  const isFemale = femaleNames.some(f => lowerName.includes(f));
  return isFemale ? '/src/assets/user-avatar-female.png' : '/src/assets/user.avatar.png';
};
